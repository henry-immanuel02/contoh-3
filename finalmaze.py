...
class Player(GameSprite):
 ...
 def fire(self):
     bullet = Bullet('hero.png', self.rect.right, self.rect.centery, 15, 20, 15)
     bullets.add(bullet)
...
monster1 = Enemy('hero.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('hero.png', win_width - 80, 230, 80, 80, 5)
